...
class Plan extends Model<Plan> {
  ...
  int?    get subdomainLimit   => getAttribute("subdomain_limit");
  int?    get ramLimit         => getAttribute("ram_limit");
  ...
  Table get table => Table(
        ...
        columns: [
          ...
          Column(name: 'subdomain_limit',    type: ColumnType.integer, defaultValue: 10),
          Column(name: 'ram_limit',          type: ColumnType.integer, isNullable: true),
